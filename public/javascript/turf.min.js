...
},{"@turf/helpers":2,"@turf/invariant":4}],2:[function(require,module,exports){
...
},{"@turf/clean-coords":1,"@turf/helpers":2,"@turf/invariant":4,"@turf/truncate":6,"turf-jsts":8}],4:[function(require,module,exports){
...
},{"@turf/helpers":2}],5:[function(require,module,exports){
...
},{"@turf/helpers":2,"@turf/meta":5}],7:[function(require,module,exports){
"use strict";function union(){for(var e=new turfJsts.GeoJSONReader,r=e.read(JSON.stringify(arguments[0].geometry)),t=1;t<arguments.length;t++)r=turfJsts.UnionOp.union(r,e.read(JSON.stringify(arguments[t].geometry)));return r=(new turfJsts.GeoJSONWriter).write(r),{type:"Feature",geometry:r,properties:arguments[0].properties}}var turfJsts=require("turf-jsts");module.exports=union,module.exports.default=union;

},{"turf-jsts":8}],8:[function(require,module,exports){
...
module.exports={union:require("@turf/union"),intersect:require("@turf/intersect")};
},{"@turf/intersect":3,"@turf/union":7}]},{},[9])(9)
});
